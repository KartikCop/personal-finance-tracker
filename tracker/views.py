...
def create_transaction(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            transaction.save()
            context={'message' : 'Transaction was added succesfully!'}
            return render(request, 'tracker/partials/transaction-success.html', context)
        else:
            context={'form': form}
            respone = render(request, 'tracker/partials/create-transaction.html', context)
            return retarget(respone, '#transaction-block')
...
def update_transaction(request, pk):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            context={'message' : 'Transaction was updated succesfully!'}
            return render(request, 'tracker/partials/transaction-success.html', context)
        else:
           context= {
          'form': form,
